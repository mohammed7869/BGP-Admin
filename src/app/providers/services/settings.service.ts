...
const baseURL = `${environment.apiUrl}/Setting`;
@Injectable({
  providedIn: 'root'
})
export class SettingsService {
  ...
  export(fdata: any): Observable<any> {
   ...
   updateWhatsAppSettings(fdata: any): Observable<any> {
    return this.httpClient.post(`${baseURL}/UpdateWhatsAppSettings`, fdata);
  }
}