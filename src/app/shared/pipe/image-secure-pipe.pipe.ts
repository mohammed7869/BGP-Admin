...
//import { ProfileService } from 'src/app/providers/services/profile.service';

@Pipe({
  name: 'imageSecurePipe'
})
export class ImageSecurePipePipe implements PipeTransform {
