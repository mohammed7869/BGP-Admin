...
export class EmailTemplateSearchComponent implements OnInit {
  ...
  onGridReady(params: any) {
    ...
    this.columnDefs = [
      ...
      { field: 'subject', headerName: 'Subject', sortable: true, filter: true, resizable: true, width: 350, },
      // {
      ...
      // },
      {
        field: 'isActive', headerName: 'Active', sortable: true, filter: true, resizable: true, width: 100,
